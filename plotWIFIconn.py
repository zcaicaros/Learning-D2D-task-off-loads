...
##################### The Wifi conn list and the list counting # of users for each interval #####
...
for n in fname[:]:
    ...
    f = subprocess.Popen(['grep', '-E', 'wifi\|connected', '/usr/666Users/'+n], stdout = subprocess.PIPE)     # subproess grep the file and retrn a file object stored in f
    ...
    for i in range(len(lines)):
        try:
            ...
            #print "can't find time 00:00:00 in line: " + str(i) # apply error handling
            continue
        try:
...
h = open('/usr/666Users/pythonprograms/fun/data/666/WIFI_on/WIFI_on', 'w')
for num in accvalues_interval:
    h.write("%s\n" % num)
e = open('/usr/666Users/pythonprograms/fun/data/666/WIFI_on/Dividor_WIFI_on', 'w')
